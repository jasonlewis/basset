...
class lessc {
	...
	protected function injectVariables($args) {
		$this->pushEnv();
		$parser = new Basset\Vendor\lessc_parser($this, __METHOD__);
	...
	protected function newFormatter() {
		$className = "Basset\Vendor\lessc_formatter_lessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "Basset\Vendor\lessc_formatter_$this->formatterName";
		}
...
class lessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('Basset\Vendor\lessc', 'preg_quote'),
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("Basset\Vendor\lessc", "preg_quote"), $directives));
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("Basset\Vendor\lessc", "preg_quote"), $stop);
